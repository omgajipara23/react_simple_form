...
const Step3 = (props) => {
    const { data, hen, next, back, addeducation, removefield, handleaddremove, fileHandel } = props;
    return (
        <form>
                                        ...
                                        return (
                                            <div style={{ marginBottom: '20px' }} key={index}>
                                                <div className="form-group" style={{ marginBottom: '15px' }}>
                                                    <input type="text" className="form-control" placeholder='Name Of Board' name='boardname' onChange={(e) => handleaddremove(e, index)} />
                                                </div>
                                                <div className="form-group" style={{ marginBottom: '15px' }}>
                                                    <input type="text" className="form-control" placeholder='Name Of Course' name='coursename' onChange={(e) => handleaddremove(e, index)} />
                                                </div>
                                                ...
                                                <div style={{ display: 'flex' }}>
                                                    ...
                                                    <div style={{ display: 'flex' }}>
                                                        ...
                                                        <div className="form-check form-check-inline">
                                                            <select className="custom-select" name='passingyear' onChange={(e) => handleaddremove(e, index)}>
                                                ...
                                                <div style={{ marginBottom: '10px' }}>
                                                    ...
                                                    <div className="form-check form-check-inline">
                                                        <input className="form-check-input" type="radio" value="english" id='english' name='language' onChange={(e) => handleaddremove(e, index)} />
                                                        <label className="form-check-label" >English</label>
                                                    </div>
                                                    <div className="form-check form-check-inline">
                                                        <input className="form-check-input" type="radio" value="hindi" id='hindi' name='language' onChange={(e) => handleaddremove(e, index)} />
                                                        <label className="form-check-label" >Hindi</label>
                                                    </div>
                                                    <div className="form-check form-check-inline">
                                                        <input className="form-check-input" type="radio" value="gujarati" id='gujarati' name='language' onChange={(e) => handleaddremove(e, index)} />
